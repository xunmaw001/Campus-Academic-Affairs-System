  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="教职工号" prop="jiaozhigonghao">
          <el-input v-model="ruleForm.jiaozhigonghao" readonly              placeholder="教职工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="国籍" prop="guoji">
          <el-input v-model="ruleForm.guoji"               placeholder="国籍" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.jiaozhigonghao)&& 'jiaoshi'==this.flag){
