  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
        <h1 class="h1" style="color:#000;fontSize:28px;">校园教务系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">教职工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaozhigonghao" class="input" type="text" placeholder="教职工号">
			   </div>
			 </div> -->
			<el-form-item label="教职工号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaozhigonghao" autocomplete="off" placeholder="教职工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="科目" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.kemu" autocomplete="off" placeholder="科目"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">国籍</div>
			   <div class="input-container">
			     <input v-model="ruleForm.guoji" class="input" type="text" placeholder="国籍">
			   </div>
			 </div> -->
			<el-form-item label="国籍" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.guoji" autocomplete="off" placeholder="国籍"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.jiaozhigonghao) && `jiaoshi` == this.tableName){
