    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="国籍" prop="guoji">
          <el-input v-model="ruleForm.guoji" 
              placeholder="国籍" clearable  :readonly="ro.guoji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="国籍" prop="guoji">
              <el-input v-model="ruleForm.guoji" 
  ...
  methods: {
    ...
    jiaozhigonghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.guoji){
                this.ruleForm.guoji = data.data.guoji
              }
        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiaoshipingjiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaoshipingjiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
