<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="有无空调" prop="youwukongdiao">
          <el-select v-model="ruleForm.youwukongdiao" placeholder="请选择有无空调">
            <el-option
                v-for="(item,index) in youwukongdiaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="有无投影" prop="youwutouying">
          <el-select v-model="ruleForm.youwutouying" placeholder="请选择有无投影">
            <el-option
                v-for="(item,index) in youwutouyingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.youwukongdiaoOptions = "有,无".split(',')
            this.youwutouyingOptions = "有,无".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
