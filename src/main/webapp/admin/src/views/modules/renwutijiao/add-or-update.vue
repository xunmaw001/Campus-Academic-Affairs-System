<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教职工号" prop="jiaozhigonghao">
          <el-input v-model="ruleForm.jiaozhigonghao" 
              placeholder="教职工号" clearable  :readonly="ro.jiaozhigonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教职工号" prop="jiaozhigonghao">
              <el-input v-model="ruleForm.jiaozhigonghao" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="任务提交" prop="renwutijiao">
          <file-upload
          tip="点击上传任务提交"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.renwutijiao?ruleForm.renwutijiao:''"
          @change="renwutijiaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.renwutijiao" label="任务提交" prop="renwutijiao">
            <el-button type="text" size="small" @click="download(ruleForm.renwutijiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='renwutijiao'){
            this.ruleForm.renwutijiao = obj[o];
	    this.ro.renwutijiao = true;
            continue;
          }
        }
      }
    ...
    renwutijiaoUploadChange(fileUrls) {
	this.ruleForm.renwutijiao = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
